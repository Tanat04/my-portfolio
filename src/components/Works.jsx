...
const ProjectCard = ({
	...
	return (
		<motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
			...
			>
				<div
					className="relative cursor-pointer w-full h-[230px]"
				...
				<div
					className="mt-5 cursor-pointer min-h-3"
					onClick={() => window.open(demo_link, "_blank")}
				>
	...
	return (
		<>
			...
			<div className="w-full flex">
				...
				>
					Following are university projects that I can use to
					demonstrate my abilities. Each project is briefly described
			...
			<div className="w-full flex flex-col items-center justify-center">
				...
				>
					Did you like it? This and much more you can find in my
